    ...
    <div className="space-y-4" data-testid="settings-page">
      ...
      {tab === 'system' ? (
        <section className="space-y-4" data-testid="settings-system-panel">
          <Card className="p-4"><pre className="text-sm overflow-auto">{JSON.stringify(data, null, 2)}</pre></Card>
        ...
        <section className="space-y-3" data-testid="settings-runtime-panel">
          ...
          <Card className="p-4"><pre className="text-sm overflow-auto">{JSON.stringify(runtime, null, 2)}</pre></Card>
        </section>
      )}
    </div>
  )
