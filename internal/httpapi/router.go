...
func Router(d Deps) *gin.Engine {
	...
	protected.POST("/runtime/sing-box/start", handlers.StartSingBox(d))
	protected.POST("/runtime/sing-box/stop", handlers.StopSingBox(d))
	protected.POST("/runtime/sing-box/restart", handlers.RestartSingBox(d))
	protected.POST("/runtime/sing-box/debug/enable", handlers.SetSingBoxDebug(d, true))
	protected.POST("/runtime/sing-box/debug/disable", handlers.SetSingBoxDebug(d, false))
	protected.GET("/runtime/sing-box/logs", handlers.SingBoxLogs(d))
